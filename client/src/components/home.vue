<template>
<div class="wrapper">
<div class="title" style="position:absolute;top:18vw;left:9vw;">
    <span style="color: #dafcff">My</span> Wave</div>
